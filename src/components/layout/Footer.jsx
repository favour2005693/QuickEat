        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 border-b border-white/10 pb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              {/* <divclassName="w-12 h-12 rounded-xl bg-red-500 flex items-center justify-center text-2xl font-bold shadow-lg">
            Q
          </div> */}
            ...
            <p className="text-gray-400 leading-relaxed max-w-md mb-6">
              QuickEat helps you order delicious meals from your favorite
              restaurants with lightning-fast delivery and a seamless
              experience.
            </p>
