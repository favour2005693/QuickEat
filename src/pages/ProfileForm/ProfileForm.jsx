                ...
                <div class="mt-2">
                  <div class="flex items-center rounded-md bg-white/5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                    ...
                    <input
                      ...
                      class="block min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-black placeholder:text-gray-900 focus:outline-none sm:text-sm/6"
                    />
                  </div>
                </div>
              </div>
                ...
                <div class="mt-6 space-y-6">
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      ...
                      <p id="comments-description" class="text-gray-400">
                  ...
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      <label for="candidates" class="font-medium text-white">
                        Candidates
                      </label>
                      <p id="candidates-description" class="text-gray-400">
                  ...
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      <label for="offers" class="font-medium text-white">
                        Offers
                      </label>
                      <p id="offers-description" class="text-gray-400">
