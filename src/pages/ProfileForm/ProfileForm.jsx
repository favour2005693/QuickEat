  ...
  return (
    <form>
      <div className="space-y-12">
        <div className="border-b border-red/10 pb-12">
              ...
              <div className="mt-2">
                <div className="flex items-center rounded-md bg-white/5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                  ...
                  <input
                    ...
                    className="block min-w-0 grow bg-transparent border-red-600 py-1.5 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6"
                  />
                </div>
              </div>
            </div>
